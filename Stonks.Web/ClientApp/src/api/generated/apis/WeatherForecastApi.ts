...
export class WeatherForecastApiRequestFactory extends BaseAPIRequestFactory {
    ...
    /**
     */
    public async weatherForecastGet(_options?: Configuration): Promise<RequestContext> {
...
export class WeatherForecastApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to weatherForecastGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async weatherForecastGet(response: ResponseContext): Promise<Array<WeatherForecast> > {
